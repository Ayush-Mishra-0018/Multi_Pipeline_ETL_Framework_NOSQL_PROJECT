...
public class Query3_HourlyErrorAnalysis {
    ...
    private static final String SCRIPT_PATH = "Pig-pipeline/src/main/resources/pig/query3.pig";
    ...
    public static void run() {
                ...
                for (String line : lines) {
                    try {
                        ...
                        if (parts.length >= 6 && !parts[2].isEmpty()) {
                            ...
                            doc.append("_id", new Document("log_date", parts[0]).append("log_hour", Integer.parseInt(parts[1])));
            ...
            try {
                ...
                for (Document doc : partialResults) {
                    ...
                    if (!finalMap.containsKey(key)) {
                        ...
                        Set<String> hostSet = (Set<String>) existing.get("hosts");
        ...
        System.out.printf(
                ...
                "log_date", "log_hour", "error_request_count", "total_request_count", "error_rate", "distinct_error_hosts", "batches"
        );
