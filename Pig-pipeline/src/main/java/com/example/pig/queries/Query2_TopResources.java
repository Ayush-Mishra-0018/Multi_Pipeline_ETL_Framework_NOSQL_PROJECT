...
public class Query2_TopResources {
    ...
    private static final String SCRIPT_PATH = "Pig-pipeline/src/main/resources/pig/query2.pig";
    ...
    public static void run() {
                ...
                for (Document doc : partialResults) {
                    ...
                    if (!finalMap.containsKey(path)) {
                        ...
                        existing.put("request_count",
                                existing.getInteger("request_count") + requestCount);

                        existing.put("total_bytes",
                                existing.getLong("total_bytes") + totalBytes);
        ...
        output.sort(
                Comparator.comparing((Document d) -> d.getInteger("request_count"))
                        .reversed()
